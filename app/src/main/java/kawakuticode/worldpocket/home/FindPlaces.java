...
import kawakuticode.worldpocket.utilities.ConnectionDectector;
import kawakuticode.worldpocket.location.GpsTracker;
import com.lisbonpocket.code.kawakuti.worldpocket.R;

import java.util.ArrayList;

import kawakuticode.worldpocket.model.Place;
import kawakuticode.worldpocket.model.PlacesService;
    ...
    private class GetPlaces extends AsyncTask<ArrayList<Place>, Integer, ArrayList<Place>> {
        ...
        protected ArrayList<Place> doInBackground(ArrayList<Place>... params) {
            PlacesService service = new PlacesService(
                    "AIzaSyBUU4vXaDoJ2P3vc_GwjpkKlOpppXS3FQY");
